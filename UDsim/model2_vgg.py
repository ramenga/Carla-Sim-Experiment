...
from utils2_vgg import INPUT_SHAPE, batch_generator
...
def main():
    ...
    if os.path.isfile('vgg_autopilot.h5') is True:
    	model = load_model('vgg_autopilot.h5')
    else:
        print("MODEL Not Found")
        model = build_vggcustom_model(args)
